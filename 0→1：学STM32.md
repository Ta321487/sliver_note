...
因芯片内部电路承受的电压有限，从I/O引脚（实物图中的”铜丝“）向里（左侧）有两个保护二极管，当瞬间电压波动进入I/O引脚时，电压大于3.3V（记作**VDD**，即电源正极）时，上方的保护二极管导通，将电压引入电源，由电源吸收；电压小于3.3V（VSS\[0V\]，即电源负极）时，下方保护二极管接通，电压进入GND。（*这个结构可以短暂地域，若较长时间接入较高的电压，则芯片也会损坏。）*
有一部分的芯片可以做到”5V容忍“
