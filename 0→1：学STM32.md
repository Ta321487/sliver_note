...
* 打开芯片手册的方法：在芯片选择页面选择Datasheet，找到![](assets/0→1：学STM32/file-20260126233747948.png)这样一张表，I/O level一列为FT的引脚，便为5V容忍引脚
![](assets/0→1：学STM32/file-20260126233627449.png)
