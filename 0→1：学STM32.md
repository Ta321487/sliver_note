...
![](assets/0→1：学STM32/file-20260131230141226.png)外部电平信号进入到输入驱动器后，首先路过上拉下拉电阻，然后经过施密特触发器转换，最后抵达输入数据寄存器/片上外设。电平信号会抵达上图的结构。上图被称为外部中断/事件控制器。![](assets/0→1：学STM32/file-20260131230141226.png)